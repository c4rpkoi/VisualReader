...
{
    public class EditChapter : IRequest<ChapterDataDto>
    {
        ...
        private static Func<EditChapter, Chapter> Converter = Projection.Compile();

        public static Expression<Func<EditChapter, Chapter>> Projection
        {
            get
            {
        ...
        public static Chapter Edit(EditChapter model)
        {
            if (model != null)
            {
