...
{
    public class EditTruyen : IRequest<TruyenDto>
    {
        ...
        private static Func<EditTruyen, Truyen> Converter = Projection.Compile();

        public static Expression<Func<EditTruyen, Truyen>> Projection
        {
            get
            {
        ...
        public static Truyen Edit(EditTruyen model)
        {
            if (model != null)
            {
