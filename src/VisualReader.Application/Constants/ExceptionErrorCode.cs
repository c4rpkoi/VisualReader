namespace VisualReader.Application.Constants
{
    public static class ExceptionErrorCode
    {
        ...
        public const string ERROR_FORMAT_VALIDATION = "ERROR.VALIDATION.WRONG_FORMAT";
        public const string ERROR_EMPTY_VALIDATION = "ERROR.VALIDATION.REQUIRED";
        public const string ERROR_ENTITY_REQUIRED = "ERROR.ENTITY.REQUIRED";
    }
}